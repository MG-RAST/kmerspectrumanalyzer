...
if __name__ == '__main__':
    ...
    parser.add_option("-i", "--index",  dest="index", default=None, help="input index ")
    ...
    parser.add_option("-l", "--cutoff",  dest="cutoff", default=None, help="median min coverage cutoff")
    parser.add_option("-o", "--outstem",  dest="outstem", default=None, help="output file stem")
